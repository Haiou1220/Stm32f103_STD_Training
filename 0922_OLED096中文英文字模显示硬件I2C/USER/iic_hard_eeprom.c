...
#include "main.h"
 ...
 //24c02模块      
void eeprom_init()  //i2c1   pb6-scl pb7-sda   
{
...
u8 eeprom_bufWrite_byteAddr(uint8_t id,uint8_t addrToWrite,uint8_t *bufWriteData,uint8_t count)  //  要修改 翻页的地址 page为8，
{	
	u32 FlagTimeoutReset = NumCountZero_1s;
	u32 FlagTimeout ;
